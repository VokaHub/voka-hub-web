...
const Testimonials: React.FC = () => {
  ...
  return (
    <section className="bg-black text-white py-32 border-t border-zinc-900 relative overflow-hidden">
         ...
         <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            ...
            <div className="lg:col-span-8 flex flex-col justify-between h-full">
               <div className="min-h-[180px]">
                  <p className="text-2xl md:text-3xl font-light text-zinc-200 leading-relaxed font-serif italic">
                     "{testimonials[currentIndex].text}"
                  </p>
               </div>
               
               <div className="flex items-center justify-between mt-12 border-t border-zinc-900 pt-8">
                  <div>
                     <div className="text-white font-medium text-lg">{testimonials[currentIndex].author}</div>
                     <div className="text-zinc-400 text-xs uppercase tracking-widest mt-1">{testimonials[currentIndex].role}</div>
                  </div>
