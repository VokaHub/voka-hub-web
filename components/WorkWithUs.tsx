...
const WorkWithUs: React.FC = () => {
  return (
    <section className="bg-black text-white py-24 md:py-40 border-t border-zinc-900 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 md:px-12 max-w-screen-xl text-center relative z-10">
        <h2 className="text-4xl md:text-8xl font-light tracking-tighter text-white leading-none mb-8 md:mb-12 uppercase">
